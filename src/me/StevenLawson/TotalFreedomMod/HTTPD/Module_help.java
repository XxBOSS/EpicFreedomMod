...
public class Module_help extends TFM_HTTPD_Module
{
    ...
    public String getBody()
    {
        ...
        responseBody
                ...
                .append(paragraph(
                "This page is an automatically generated listing of all plugin commands that are currently live on TylerFreedom. "
        ...
        while (itCommandsByPlugin.hasNext())
        {
            ...
            {
                if ("TylerFreedomMod".equals(pluginName))
                {
    ...
    {
        return "TylerFreedomMod :: Command Help";
    }
